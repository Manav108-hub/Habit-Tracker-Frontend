...
"[project]/src/app/dashboard/badges/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BadgesPage() {
    ...
    const loadBadges = async ()=>{
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gamificationAPI"].getBadges();
            setBadges(data);
        } catch (error) {
...
_s(BadgesPage, "QDOubHRomXiqFNd+fNP95Ut07T0=");
_c = BadgesPage;
...
//# sourceMappingURL=src_app_dashboard_badges_page_tsx_4c6e8d2d._.js.map